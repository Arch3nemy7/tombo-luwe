...
if (isset($_POST['reg_user'])) {
  ...
  $username = pg_real_escape_string($db, $_POST['username']);
  $email = pg_real_escape_string($db, $_POST['email']);
  $password_1 = pg_real_escape_string($db, $_POST['password_1']);
  $password_2 = pg_real_escape_string($db, $_POST['password_2']);
...
if (isset($_POST['login_user'])) {
  $username = pg_real_escape_string($db, $_POST['email']);
  $password = pg_real_escape_string($db, $_POST['password']);
