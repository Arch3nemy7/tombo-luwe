                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <select name="product_type" id="" product_type>
                        <option value="1">Nugget</option>
                        <option value="2">Sosis</option>
                        <option value="3">Siomay</option>
                        <option value="4">Bakso</option>
                        <option value="5">Daging</option>
                        <option value="6">Kentang</option>
                        <option value="7">Dimsum</option>
                      </select>
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <select name="brand" id="" brand>
                        <option value="1">Champ</option>
                        <option value="2">So Good</option>
                        <option value="3">Sunny Gold</option>
                        <option value="4">Kanzler</option>
                        <option value="5">Belfoods</option>
                        <option value="6">Fiesta</option>
                        <option value="7">UMKM</option>
                      </select>
                    </div>
                  </div>
